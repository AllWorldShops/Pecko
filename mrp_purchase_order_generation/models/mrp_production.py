...
#                 print(key.name,key)
                ...
                if purchase_order_exist_ids:
                    ...
                    for line in val:
                        line_count = 0
#                         print(line_count,"0")
                        for order_lines_exist in purchase_order_exist_ids.order_line:
                            if order_lines_exist.product_id == line['product_id']:
                                order_lines_exist.product_qty = line['qty'] + order_lines_exist.product_qty
                                line_count +=1
